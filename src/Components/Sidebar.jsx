  ...
  const menuItems = [
    ...
    },
    {
      ...
      children: [
        ...
        { key: "2-22", label: <Link to="/scheme-type" style={{ color: "#fff" }}>Scheme Type</Link> },
        { key: "2-23", label: <Link to="/scheme-name" style={{ color: "#fff" }}>Scheme Name</Link> },
        { key: "2-24", label: <Link to="/scheme-group" style={{ color: "#fff" }}>Scheme Group</Link> },
        { key: "2-25", label: <Link to="/scheme-member" style={{ color: "#fff" }}>Scheme Member</Link> },
    ...
    },
    {
      ...
      children: [
        ...
        { key: "3-8", label: <Link to="/ShemeSettlement" style={{ color: "#fff" }}>Sheme Settlement</Link> },
        { key: "3-9", label: <Link to="/MemberDiscontinue" style={{ color: "#fff" }}>Member Discontinue</Link> },
        { key: "3-10", label: <Link to="/schemesettlementregister" style={{ color: "#fff" }}>Scheme Settlement Register</Link> },
        { key: "3-11", label: <Link to="/schemediscontinueregister" style={{ color: "#fff" }}>Scheme Discontinue Register</Link> },
        { key: "3-12", label: <Link to="/membercardregister" style={{ color: "#fff" }}>MemberCard Register</Link> },
